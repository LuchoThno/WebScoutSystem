/*
  # Financial Management Tables and Views

  1. New Tables
    - `transactions` - Stores income and expense transactions
    - `budgets` - Stores budget information by category
    - `financial_reports` - Stores generated financial reports
  
  2. Views
    - `monthly_financial_summary` - Monthly breakdown of finances
    - `category_spending_analysis` - Analysis of spending by category
    - `budget_compliance` - Budget vs actual spending comparison
...
-- Create unified access policies (only if they don't exist)
DO $$
BEGIN
    IF NOT EXISTS (
